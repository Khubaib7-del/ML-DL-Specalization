...
plt.style.use(style_path if os.path.exists(style_path) else './deeplearning.mplstyle')
...
def load_house_data():
    path = os.path.join(os.path.dirname(__file__), "data", "houses.txt")
    if not os.path.exists(path):
        path = "./data/houses.txt"
